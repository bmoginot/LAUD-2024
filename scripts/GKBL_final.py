# take csv output from kraken2-output-manipulator and modify (filter reads, group by location) before rarefaction
...
def main():
    ...
    paths = glob.glob('/home/bmoginot/new_kraken/k2om_output/*.csv')
    ...
    # iterate through csv files, filtering reads and grouping by location
    for csv in paths:
