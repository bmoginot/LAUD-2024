...
Data=read.table("/home/bmoginot/new_kraken/filtered_reads/pat3_filtered.csv", sep=",", row.names = 1, header=TRUE)
...
abline(0, 1)
pdf("/home/bmoginot/new_kraken/curves/pat3_curve.pdf")
