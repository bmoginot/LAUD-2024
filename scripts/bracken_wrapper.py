...
def run_bracken(pat):
    ...
    for report in paths:
        ...
        bracken_path=f'/home/bmoginot/new_kraken/bfiles/{pat}/{sig}_new'
        breport_path=f'/home/bmoginot/new_kraken/breports/{pat}/{sig}_new'
        # run bracken
...
def parse_bracken(pat):
    ...
    samples = glob.glob(f'/home/bmoginot/new_kraken/breports/{pat}/*')
...
'''
But I'm not a wrapper... B)
1. Take Kraken2 reports and get species abundance with Bracken
2. Filter and reformat Bracken output; write to txt
'''

def main():
    # set participant on which to run bracken
    pat = 'pat1'
